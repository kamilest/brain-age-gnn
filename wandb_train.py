"""
Script called by Weights & Biases framework for hyperparameter tuning.

Accepts commnd line arguments for population graph and GNN parameterisation.
Constructs the population graph if it does not exist, otherwise loads the stored version.
Trains the population graph on the selected graph neural network with cross-validation.
"""
...
brain_gnn_train.train_with_cross_validation(args.model, population_graph, device,
